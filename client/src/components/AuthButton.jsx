...
class Auhtentication extends Component {
  ...
  render() {
    const { authLoading, authError, registerLoading, registerError } = this.props;
                ...
                <p className="text-center text-danger error-message">
                  <span>
                    {!registerLoading && registerError ? (
                      <FlashMessage duration={3000}>{registerError}</FlashMessage>
                    ) : (
                      false
                    )}
                  </span>
            ...
            <Form onSubmit={this.handleFormLogin}>
              <Modal.Body>
                <InputGroup className="mb-3">
                  <FormControl
                    type="email"
                    placeholder="nauval@dumblix.com"
                    aria-label="Username"
                ...
                <p className="text-center text-danger error-message">
                  <span>
                    {!authLoading && authError ? (
                      <FlashMessage duration={3000}>{authError}</FlashMessage>
                    ) : (
                      false
                    )}
                  </span>
